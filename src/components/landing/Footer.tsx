          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 w-full md:w-auto">
            <div>
              ...
              <ul className="space-y-2">
                <li><a onClick={() => scrollToSection('features')} className="text-muted-foreground hover:text-foreground cursor-pointer">Features</a></li>
                <li><a onClick={() => scrollToSection('pricing')} className="text-muted-foreground hover:text-foreground cursor-pointer">Pricing</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a onClick={() => scrollToSection('faq')} className="text-muted-foreground hover:text-foreground cursor-pointer">FAQ</a></li>
